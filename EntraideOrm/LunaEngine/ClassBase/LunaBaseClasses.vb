...
#End Region
    ...
    Partial Public Class LunaContext
        ...
        Shared Sub New()
            ...
            _ConnectionString = ConfigManager.Settings.ConnectionString
            ...
            _ShareConnection = ConfigManager.Settings.ShareConnection
            ...
            _DisableLazyLoading = ConfigManager.Settings.DisableLazyLoading
        ...
        Public Shared ReadOnly Property SandBox As Boolean
            Get
                Dim ris As Boolean = False
                Dim ParamName As String = ProjectId & ".LUNA.SandBox"
        ...
        Friend Shared Function GetProviderFactory() As String
            If _ProviderFactory = String.Empty Then
                ...
                Else
                    _ProviderFactory = "MySql.Data.MySqlClient"
                End If
            End If
